      ...
      <Content>
        <div className="signup-data-form-normal">
          <div style={{ textAlign: "center" }}>
            <h2>Đăng kí thông tin tài khoản</h2>
          </div>
          <Form name="sign-normal" initialValues={{ remember: true }} className="form-data" onFinish={onFinish}>
            ...
            <Row gutter={[10, 10]} justify="center">
              <Col xl={6} lg={6} md={12} sm={12} xs={24}>
                ...
                >
                  <Select labelInValue={true} showSearch optionFilterProp="children" onChange={handleChangeProvince}>
              ...
              <Col span={4} offset={1}>
                ...
                >
                  <Select labelInValue={true} showSearch optionFilterProp="children" onChange={handleChangeDistrict}>
              ...
              <Col xl={6} lg={6} md={12} sm={12} xs={24}>
                ...
                >
                  <Select labelInValue={true} showSearch optionFilterProp="children" onChange={handleChangeWard}>
                    {wards.map((ward) => {
                      return (
              ...
              <Col span={4} offset={1}>
                ...
                >
                  <Input type="text" size="middle" onChange={handleStreetChange} />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={[10, 10]} justify="center">
              <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      ...
                      message: "Tên đăng nhập chỉ được bao gồm chữ cái, số và _"
                    },
                    {
                      min: 6,
                ...
                {/* {isUsernameExist && <span style={{ color: "red" }}>Tên đăng nhập đã tồn tại</span>} */}
              </Col>
              <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                <label>Email</label>
                <Form.Item
